...
int64 nChainStartTime = 1453552200;
...
void SyncWithWallets(const CTransaction& tx, const CBlock* pblock, bool fUpdate, bool fConnect)
{
    if (!fConnect)
    {
        // TBCoin: wallets need to refund inputs when disconnecting coinstake
        if (tx.IsCoinStake())
        {
            BOOST_FOREACH(CWallet* pwallet, setpwalletRegistered)
                if (pwallet->IsFromMe(tx))
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "TBCoin";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1453552200;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1029479;
        ...
        assert(block.hashMerkleRoot == uint256("0xf7651c08a62ebf3cf05af429d6dbe4afe64a71a31e28413740d2134f511601ad"));
...
unsigned char pchMessageStart[4] = { 0xcd, 0xac, 0xda, 0xcd };
